<x-layout>
    ...
    <div class="pt-28 px-10 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 overflow-x-auto text-xs sm:text-base">
            <form action="{{ route('update.product', $produk->id) }}" method="post" class="p-4 md:p-5"
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="namaProduk" id="namaProduk"
                            ...
                            placeholder="Masukan Nama Produk" value="{{ $produk->namaProduk }}" required="">
                    </div>
                    <div class="col-span-2">
                        ...
                        <input type="text" name="harga" id="harga"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="{{ $produk->harga }}" required="">
                    </div>
                    <div class="col-span-2">
                        ...
                        <input type="number" name="stok" id="stok"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Masukan jumlah Stok Barang" value="{{ $produk->stok }}" required="">
                    </div>
                    <div class="col-span-2">
                        ...
                        <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="fotoProduk">Masukan
                            foto dari
                            Produk diatas
                        </div>
                    </div>
