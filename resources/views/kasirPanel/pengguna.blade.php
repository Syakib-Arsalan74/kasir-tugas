                ...
                <form>
                    ...
                    <div class="flex items-center mt-4">
                        <input type="text" class="text-xs border-1 border-gray-200 rounded-md sm:p-2"
                            placeholder="Cari Peengguna" name="search">
                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td class="border border-gray-200 p-2">{{ $user->username }}</td>
...
<div id="add-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form action="{{ route('tambah.pengguna') }}" method="post" class="p-4 md:p-5">
                @csrf
...
<div id="edit-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <!-- Modal body -->
            @foreach ($users as $user)
                <form action="{{ route('edit.pengguna', $user->id) }}" method="post" class="p-4 md:p-5">
                    @csrf
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            <label for="name"
