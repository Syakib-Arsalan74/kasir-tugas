<x-layout>
    ...
    <div class="mx-auto max-w-md py-16 sm:py-24 lg:py-28">
        <div class="text-center">
            <h1 class="text-5xl font-bold tracking-tight text-balance text-gray-900 sm:text-7xl">Selamat Datang</h1>
            <p class="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">Lihat laporan penjualan secara real-time untuk analisis performa bisnis</p>
