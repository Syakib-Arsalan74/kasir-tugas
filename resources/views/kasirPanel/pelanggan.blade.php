                ...
                <table class="table-auto w-full text-xs sm:text-base text-center">
                    ...
                    <tbody>
                        @foreach ($pelanggans as $pelanggan)
                            <tr>
                                <td class="border-2 border-gray-200 p-2">{{ $loop->iteration }}</td>
                                <td class="border-2 border-gray-200 p-2">{{ $pelanggan->namaPelanggan }}</td>
                                <td class="border-2 border-gray-200 p-2">{{ $pelanggan->alamat }}</td>
                                <td class="border-2 border-gray-200 p-2">{{ $pelanggan->noTelp }}</td>
                                <td class="border-2 border-gray-200 p-2">
                                    <div class="flex items-center">
                                        <a href="{{ route('edit.pelanggan', $pelanggan->namaPelanggan) }}"
                                        ...
                                        <form action="{{ route('hapus.pelanggan', $pelanggan->id) }}" method="post">
                                            ...
                                            <button type="button" data-modal-target="popup-modal"
                                                data-modal-toggle="popup-modal" id="delete-button"
...
<div id="add-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form action="{{ route('tambah.pelanggan') }}" method="post" class="p-4 md:p-5">
                @csrf
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        <label for="name"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama</label>
                        <input type="username" name="namaPelanggan" id="name"
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete
                    this Pelanggan?</h3>
                <button data-modal-hide="popup-modal" type="button" id="btn-confirm-delete"
